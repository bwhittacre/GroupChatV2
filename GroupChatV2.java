    ...
    public static void main(String[] args)
    {
        ...
        else 
        {
            try
            {
                ...
                //group chat are. As an added measure, it also asks for the
                //password, which in this case is a trick question, and is
                //blank. It also casts to the socket based on the 
                ...
                password = "";
                System.out.print("What is the pass my dude?: ");
                passanswer = sc.nextLine();
                if(password == passanswer){
                System.out.print("What yo name is?: ");
                name = sc.nextLine();
                ...
                while(true)
                {
                    ...
                    String message;
                    message = sc.nextLine();
                    if(message.equalsIgnoreCase(GroupChatV2.TERMIMATE))
                    {
                        finished = true;
                    ...
                    System.out.print("Reload the program again you fraud.");
                }
    ...
    public void run()
    {
        while(!GroupChatV2.finished)
        {
            ...
            try
            {
                ...
                if(!message.startsWith(GroupChatV2.name))System.out.println(message);
            }
